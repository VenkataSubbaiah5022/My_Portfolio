...
const navigationCommands: CommandItem[] = [
  ...
  },
  {
    ...
    group: "navigate",
    label: "System Design",
    description: "Architecture diagrams & deep dives",
    href: "/system-design",
    keywords: ["architecture", "diagrams", "microservices", "iot"],
  },
  {
    id: "talentvault-case-study",
    group: "navigate",
    label: "TalentVault AI Case Study",
    description: "Flagship project deep dive",
    href: "/projects/talentvault-ai",
    keywords: ["case study", "ai", "talentvault"],
  },
  {
    id: "jobsprint-case-study",
    group: "navigate",
    label: "JobSprint Case Study",
    description: "AI job agent architecture",
    href: "/projects/jobsprint",
    keywords: ["case study", "playwright", "automation"],
  },
  {
    id: "challenges",
    group: "navigate",
